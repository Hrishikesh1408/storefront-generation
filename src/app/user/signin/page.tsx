...
/**
 * The Sign-In page component for users to authenticate.
 * Displays the branding and the Google login OAuth button.
 *
      ...
      <main className="flex flex-1 items-center justify-center px-6">
        <div className="w-full max-w-md bg-white rounded-xl shadow-md border-gray">
          ...
          <div className="flex border-b">
            <div className="flex-1 text-center py-4 text-lg font-semibold">
              Sign In
            </div>
          </div>
